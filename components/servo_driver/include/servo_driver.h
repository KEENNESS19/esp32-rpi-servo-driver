...
/**
 * @brief 同步读取多个舵机的当前速度（BIT15为方向位）
 * @param servo_ids 舵机ID数组
 * @param id_count ID数量
 * @param speeds 输出速度数组（uint16_t类型）
 * @param directions 输出方向数组（bool类型）
 * @param timeout_ms 超时时间(毫秒)
 * @return 成功读取的舵机数量
 */
...
/**
 * @brief 读取单个舵机的当前速度（BIT15为方向位）
 * @param id 舵机ID
 * @param speed 输出速度值
 * @param direction 输出方向（true=正向，false=反向）
 * @param timeout_ms 超时时间(毫秒)
 * @return 状态码
 */
 ...
 * @param servo_ids 舵机ID数组
 * @param id_count ID数量
 * @param positions 输出位置数组（uint16_t类型）
 * @param timeout_ms 超时时间(毫秒)
 * @return 成功读取的舵机数量
 */
 ...
 * @param servo_ids 舵机ID数组
 * @param id_count ID数量
 * @param temperatures 输出温度数组（uint8_t类型）
 * @param timeout_ms 超时时间(毫秒)
 * @return 成功读取的舵机数量
 */
